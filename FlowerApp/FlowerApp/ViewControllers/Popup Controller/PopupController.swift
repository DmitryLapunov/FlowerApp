...
class PopupController: UIViewController {
    ...
    class func showPopup(duration: TimeInterval = 1.3, message: String = "Товар добавлен в «Избранное»", textColor: UIColor = UIColor(named: "MainLabelColor") ?? .black, backgroundColor: UIColor = UIColor(named: "TertiaryColor") ?? .systemGray5, useShadow: Bool = true) {
